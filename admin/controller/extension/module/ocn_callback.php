...
class ControllerExtensionModuleOCNCallBack extends Controller {
	...
	private function viewListItems() {
		...
		$data['result'] = 0;//sprintf($this->language->get('text_pagination'), $paginate['from'] + 1, $paginate['current_page'] == $paginate['last_page'] ? $paginate['total'] : $paginate['to'], $paginate['total']);
