            ...
            <table id="discount" class="table list product-extra-table">
              ...
              <tbody id="discount-row<?php echo $discount_row; ?>">
                <tr>
                  ...
                  <td class="left"><input style="text-align:center" type="text" name="product_discount[<?php echo $discount_row; ?>][date_start]" value="<?php echo ($product_discount['date_start'] != '0000-00-00' ? $product_discount['date_start'] : ''); ?>" class="date datepicker" data-format="YYYY-MM-DD" data-date-format="YYYY-MM-DD"/></td>
                  <td class="left"><input style="text-align:center" type="text" name="product_discount[<?php echo $discount_row; ?>][date_end]" value="<?php echo ($product_discount['date_end'] != '0000-00-00' ? $product_discount['date_end'] : ''); ?>" class="date datepicker" data-format="YYYY-MM-DD" data-date-format="YYYY-MM-DD"/></td>
          ...
          <table id="special" class="table list product-extra-table">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><input style="text-align:center" type="text" name="product_special[<?php echo $special_row; ?>][date_start]" value="<?php echo ($product_special['date_start'] != '0000-00-00' ? $product_special['date_start'] : ''); ?>" class="date datepicker" data-format="YYYY-MM-DD" data-date-format="YYYY-MM-DD"/></td>
                <td class="left"><input style="text-align:center" type="text" name="product_special[<?php echo $special_row; ?>][date_end]" value="<?php echo ($product_special['date_end'] != '0000-00-00' ? $product_special['date_end'] : ''); ?>" class="date datepicker" data-format="YYYY-MM-DD" data-date-format="YYYY-MM-DD"/></td>
