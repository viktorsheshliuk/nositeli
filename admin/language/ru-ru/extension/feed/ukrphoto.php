...
$_['entry_price_nacenka']    = 'Наценка для цены';
...
$_['help_price_nacenka']     = 'На сколько умножать цену, например 1.1 - соответствует наценке 10%';
...
$_['help_ukrphoto']     = 'Тема на <a target="_blank" href="//forum.opencart.pro/topic/1059-yandexmarket-20/">Форуме</a>';
