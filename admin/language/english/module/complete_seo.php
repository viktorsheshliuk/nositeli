...
$_['text_seo_remove']		= 'Remove sentence:<span class="help">Remove some sentence when generating the urls, it will remove the sentence anywhere in the string<br/>Must be separated by |</span>';
$_['text_seo_replace']		= 'Replace:<span class="help">Replace sentences when generating the urls<br/>For example:<br/><b>&:and</b> means replace "&" by "and"<br/>If you want to just remove do not set any replacement</span>';
