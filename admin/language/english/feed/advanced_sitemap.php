...
$_['text_hour'] = 'Hour(s)';
$_['text_day'] = 'Day(s)';
$_['entry_data_feed']	= 'Full Feed:<span class="help">Feed containing all languages using hreflang tag (hreflang will be displayed in case of more than one language)<br/><br/>Give this sitemap to google, it will fetch all sub-sitemaps</span>';
$_['entry_lang_feed']	= 'Lang based feeds:<span class="help">Use these if you prefer separate language version</span>';
$_['entry_grid_feed']	= 'Grid product feeds:<span class="help">A grid of product thumbnails<br/><br/>This is not a feed for google it is only for you if you want to have a quick view of your products thumbnails</span>';
