...
$(document).ready(function() {
    $(".minus").click(function() {
        // Если кнопка находится внутри SimpleCheckout — отменяем этот обработчик
        if ($(this).closest('#simplecheckout_cart').length) {
            return;
        }
        var o = $(this).parent().find(".input_amount")
          , n = parseInt(o.val()) - 1;
        return n = n < 1 ? 1 : n,
        o.val(n),
        o.change(),
