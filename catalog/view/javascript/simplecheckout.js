(function($) {
    window.Simplecheckout = function(params) {
        ...
        this.selectors = {
            ...
            buttonQuickOrder:"#simplecheckout_button_quick_order",
            ...
            var initButtons = function() {
                if (self.stepsCount > 1) {
                    if (self.currentStep == 1) {
                        ...
                        $mainContainer.find(self.selectors.buttonQuickOrder).show();
                    } else {
                        $mainContainer.find(self.selectors.buttonBack).hide();
                        $mainContainer.find(self.selectors.buttonQuickOrder).hide();
                    }
