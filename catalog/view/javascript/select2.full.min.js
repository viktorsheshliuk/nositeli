    ...
    var b = (function () {
            ...
            return (
                ...
                b.define("select2/i18n/en", [], function () {
                    ...
                    var translations = {
                        uk: {
                            ...
                            inputTooLong: function (a) {
                                var n = a.input.length - a.maximum;
                                return (
                                    "Будь ласка, видаліть " +
                                    n +
                                    " символ" +
                            ...
                            inputTooShort: function (a) {
                                var n = a.minimum - a.input.length;
                                return "Будь ласка, введіть " + n + " або більше символів";
                            },
                            ...
                            maximumSelected: function (a) {
                                return (
                                    ...
                                    a.maximum +
                                    " елемент" +
                                    (a.maximum % 10 === 1 && a.maximum % 100 !== 11 ? "" : "ів")
                                );
                            },
                            noResults: function () {
                        ...
                        ru: {
                            ...
                            inputTooShort: function (a) {
                                var n = a.minimum - a.input.length;
                                return "Пожалуйста, введите " + n + " или более символов";
                            },
                            loadingMore: function () {
                            ...
                            maximumSelected: function (a) {
                                return (
                                    ...
                                    a.maximum +
                                    " элемент" +
                                    (a.maximum % 10 === 1 && a.maximum % 100 !== 11 ? "" : "ов")
                                );
                            },
                            noResults: function () {
                    ...
                    // Определяем язык из <html lang="...">
                    // OpenCart 3 ставит 'uk' или 'ru' в зависимости от языка магазина
                    var htmlLang = "";
                    try {
                        if (typeof jQuery !== "undefined") {
                            htmlLang = (jQuery("html").attr("lang") || "").toLowerCase();
                    ...
                    // Берём первые 2 символа: 'uk-ua' -> 'uk', 'ru-ru' -> 'ru'
                    var langKey = htmlLang.substring(0, 2);
