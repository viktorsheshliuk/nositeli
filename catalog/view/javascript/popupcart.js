...
function add_class() {
	...
	//ниже список селекторов для кнопок добавления в корзину
	$('.cart .button, .btn-group .btn, .btn-group .btn-primary, .button-group button, .button-add .btn.btn-primary').each(function() {
