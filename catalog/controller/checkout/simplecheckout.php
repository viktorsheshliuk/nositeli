...
class ControllerCheckoutSimpleCheckout extends SimpleController {
    ...
    private function order() {
        ...
        $data['firstname']              = $customer_info['firstname'] . ' '. $this->simplecheckout->customer_parentname; 
        ...
        $data['payment_firstname']      = $payment_address['firstname'] . ' ' . $this->simplecheckout->customer_parentname; 
        ...
        if ($this->simplecheckout->hasShipping()) {
            $data['shipping_firstname']      = $shipping_address['firstname'] . ' '. $this->simplecheckout->customer_parentname; 
