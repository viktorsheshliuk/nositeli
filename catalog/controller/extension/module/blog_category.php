	...
	public function index() {
		...
		foreach ($categories as $category) {
			...
			if ($category['blog_category_id'] == $data['blog_category_id']) {
				...
				foreach($children as $child) {
					...
					$children_data[] = array(
						...
						'href' => $this->url->link('blog/category', 'blogcategoryid=' . $category['blog_category_id'] . '-' . $child['blog_category_id'])
					);
				}
			}
			...
			$data['categories'][] = array(
				...
				'href'        => $this->url->link('blog/category', 'blogcategoryid=' . $category['blog_category_id'])
			);
		}
