...
class ControllerExtensionModuleProscroller extends Controller {
	...
	public function index($setting) {
		...
		if (isset($setting['module_footer'][$this->config->get('config_language_id')])) {

			$data['text_footer_link'] = html_entity_decode($setting['module_footer'][$this->config->get('config_language_id')]['title'], ENT_QUOTES, 'UTF-8');
			
		} else {

				$data['text_footer_link'] = '';
		}
		...
		$data['footer_link'] = $setting['footer_link'] == "" ? null: $setting['footer_link'];
