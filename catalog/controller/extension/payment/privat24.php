...
class ControllerExtensionPaymentPrivat24 extends Controller {
	public function index() {
		...
		$data['action'] = 'https://api.privatbank.ua/p24api/pay_pb';           
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/privat24.twig')) {
			return $this->load->view($this->config->get('config_template') . '/template/extension/payment/privat24.twig', $data);
		} else {
			return $this->load->view('extension/payment/privat24', $data);
			//return $this->load->view('default/template/payment/privat24', $data);
		}
	}
