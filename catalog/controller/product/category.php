...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		$this->document->addScript('catalog/view/javascript/slick/slick.min.js','footer');
		...
		// Добавление в Title и Description Пагинации
            if ($page>1){
            $old_title = $this->document->getTitle();
            $old_desc = $this->document->getDescription();
            $this->document->setTitle($old_title . ' | Cтраница '. $page);
            if ($old_desc != '') {
            	$this->document->setDescription($old_desc . ' | Cтраница '. $page);
             }
        	}
	...
	public function getAllParentCategory() {
		...
		$this->response->setOutput($this->load->view('catalog/all_category_parent', $data));
