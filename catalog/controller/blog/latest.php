	...
	public function index() { 
		...
		$data['sorts'] = array();
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('blog/latest', 'blogcategoryid=' . '&sort=p.sort_order&order=ASC' . $url)
			);
			
			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_asc'),
				'value' => 'pd.name-ASC',
				'href'  => $this->url->link('blog/latest', 'blogcategoryid=' . '&sort=pd.name&order=ASC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_desc'),
				'value' => 'pd.name-DESC',
				'href'  => $this->url->link('blog/latest', 'blogcategoryid=' . '&sort=pd.name&order=DESC' . $url)
			);
