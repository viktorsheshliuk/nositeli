...
$_['text_city_placeholder']          = 'Выберите населенный пункт';
$_['text_city_department']           = 'Выберите отделение или почтомат';
...
$_['text_summary']                   = 'Товары в корзине';
